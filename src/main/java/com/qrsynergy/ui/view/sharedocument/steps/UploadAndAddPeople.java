    ...
    private void createUploadFinishedHandler() {
        uploadFinishedHandler = (InputStream stream, String fileName, String mimeType, long length, int filesLeftInQueue) -> {
            ...
            try{
                ...
                if(type.equals("xlsx") || type.equals("pdf") || type.equals("zip")){
                    ...
                    switch (type){
                        ...
                        case "pdf": {
                            fileInfo.setDocumentType(DocumentType.PDF);
                            fileInfo.setDiskName(fileInfo.getUrl() + ".pdf");
                            break;
                        }
                        case "zip": {
                            fileInfo.setDocumentType(DocumentType.ZIP);
                            fileInfo.setDiskName(fileInfo.getUrl() + ".zip");
                            break;
                        }
                    }
                    ...
                    Notification.show("Only 'xlsx, zip and pdf' format is supported", Notification.Type.WARNING_MESSAGE);
                }
            }
            catch(Exception e){
